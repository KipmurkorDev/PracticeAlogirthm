Create or Replace function add_user(id int,firstname varchar,lastname varchar,user_email varchar, access_token varchar, status varchar, job varchar, isstudent boolean,inactivity int, deleted boolean) 
returns text
language plpgsql
AS 
$$
